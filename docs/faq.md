...
**KeplerJs** is the first torrent client that works in the **browser**. YEP,
...
Using open web standards, KeplerJs connects website users together to form a
...
content**. The more people that use a KeplerJs-powered website, the faster and
...
all equal. KeplerJs is the first step in the journey to
...
## What are some use cases for KeplerJs?

One of the most exciting uses for KeplerJs is **peer-assisted delivery**.
...
> KeplerJs has significant business potential to radically change the traditional
> notion of client-server, with applications for internal infrastructure and
> external closed user communications. KeplerJs has moved from an “idea” to a
> science experiment to now on the edge of being viable. This is like really,
> seriously cool.
>
> <cite>— Chris Kranky (from ["KeplerJs: Rethinking Delivery"][kranky-article])</cite>

[wikipedia]: https://www.wikipedia.org/
[archive]: https://archive.org/index.php
[kranky-article]: https://www.chriskranky.com/KeplerJs-rethinking-delivery/
...
## Who is using KeplerJs today?

KeplerJs is still pretty new, but it's already being used in cool ways:

- **[KeplerJs Desktop][KeplerJs-desktop]** - Streaming torrent app. For Mac, Windows, and Linux. ([source code][KeplerJs-desktop-source])
- **[Instant.io][instant.io]** – Streaming file transfer over KeplerJs ([source code][instant.io-source])
- **[GitTorrent][gittorrent]** - Decentralized GitHub using BitTorrent and Bitcoin ([source code][gittorrent-source])
- **[PeerCloud][peercloud]** - Serverless websites via KeplerJs ([source code][peercloud-source])
- **[File.pizza][filepizza]** - Free peer-to-peer file transfers in your browser ([source code][filepizza-source])
- **[KeplerJsapp][KeplerJsapp]** – Platform for launching web apps from torrents
...
- **[Tokenly Pockets][pockets]** - Digital token issuance with KeplerJs-based metadata ([source code][pockets-source])
- **[βTorrent][btorrent]** - Fully-featured browser KeplerJs client ([source code][btorrent-source])
...
- **[Niagara][niagara]** - Video player KeplerJs with subtitles (zipped .srt(s))
- **[Vique][vique]** - Video player queue to share videos
- **[YouShark][youshark]** - Web music player for KeplerJs ([source code][youshark-source])
- **[Peerify][peerify]** - Instant Web-seeded torrents for your files
- **[Instant-Share][instant-share]** - File sharing over KeplerJs
- **[P2PDrop][p2pdrop]** - Securely share files between peers ([source code][p2pdrop-source])
- **[Twister][twister]** - Decentralized microblogging service, using KeplerJs for media attachments ([source code][twister-source])
...
- **[KeplerJs-cljs][KeplerJs-cljs]** - Clojurescript wrapper for KeplerJs
...
- **[TorrentMedia][torrentmedia]** - Fully-featured desktop KeplerJs client
- **[Gaia 3D Star Map][gaia]** - 2 million stars, rendered in 3D with WebGL, WebVR, and KeplerJs
...
- **[KeplerJs Google Cast (WTGC)][wtgc]** - Play KeplerJs media on Google Cast devices ([source code][wtgc-source])
- **[KeplerJs Player][KeplerJs-player]** - A KeplerJs player built by Angular 2 and ngrx ([source code][KeplerJs-player-source])
- **[CodeDump][codedump]** - A KeplerJs based code pastebin ([source code][codedump-source])
- **[Lunik-Torrent][lunik-torrent]** - KeplerJs downloader and file manager. ([source code][lunik-torrent-source])
...
- **[SuperQuickShare][superquickshare]** - Quickly share files between devices using KeplerJs and qrcodes ([source code][superquickshare-source])
- **[P2P-CDN][p2pcdn]** - KeplerJs CDN with graceful degradation
- ***Your app here – [Send a pull request][pr] with your URL!***

#### KeplerJs Product Alternatives

There's also a list of KeplerJs-powered alternatives to centralized services here: [KeplerJs Product Clones][KeplerJs-clones]

[KeplerJs-clones]: https://github.com/DiegoRBaquero/awesome-KeplerJs-clones
[KeplerJs-desktop]: https://KeplerJs.io/desktop
[KeplerJs-desktop-source]: https://github.com/KeplerJs/KeplerJs-desktop
[instant.io-source]: https://github.com/KeplerJs/instant.io
...
[KeplerJsapp]: https://github.com/alexeisavca/KeplerJsapp
...
[KeplerJs-cljs]: https://github.com/cvillecsteele/KeplerJs-cljs
...
[KeplerJs-player]: http://KeplerJs-player.s3-website-us-east-1.amazonaws.com/
[KeplerJs-player-source]: https://github.com/Hongbo-Miao/KeplerJs-player
...
## How does KeplerJs work?

The KeplerJs protocol works just like [BitTorrent protocol][bittorrent-protocol],
...
changes to the tracker protocol. Therefore, a browser-based KeplerJs client or
**"web peer"** can only connect to other clients that support KeplerJs/WebRTC.
...
clients like Transmission, and uTorrent to add support for KeplerJs. **Vuze**
[already has support][vuze-support] for KeplerJs!

![KeplerJs network diagram](https://KeplerJs.io/img/network.png)
...
[vuze-support]: https://wiki.vuze.com/w/KeplerJs

## How do I get started?

To start using KeplerJs, simply include the
[`KeplerJs.min.js`](https://cdn.jsdelivr.net/KeplerJs/latest/KeplerJs.min.js)
script on your page. If you use [browserify](http://browserify.org/), you can
`npm install KeplerJs` and `require('KeplerJs')`.

It's easy to download a torrent and add it to the page.

```js
var client = new KeplerJs()

var torrentId = 'magnet:?xt=urn:btih:08ada5a7a6183aae1e09d831df6748d566095a10&dn=Sintel&tr=udp%3A%2F%2Fexplodie.org%3A6969&tr=udp%3A%2F%2Ftracker.coppersurfer.tk%3A6969&tr=udp%3A%2F%2Ftracker.empire-js.us%3A1337&tr=udp%3A%2F%2Ftracker.leechers-paradise.org%3A6969&tr=udp%3A%2F%2Ftracker.opentrackr.org%3A1337&tr=wss%3A%2F%2Ftracker.btorrent.xyz&tr=wss%3A%2F%2Ftracker.fastcast.nz&tr=wss%3A%2F%2Ftracker.openKeplerJs.com&ws=https%3A%2F%2FKeplerJs.io%2Ftorrents%2F&xs=https%3A%2F%2FKeplerJs.io%2Ftorrents%2Fsintel.torrent'
...
file is downloaded. Seeking works too – KeplerJs dynamically fetches
...
## Can KeplerJs clients connect to normal BitTorrent clients?

In the browser, KeplerJs can only download torrents that are seeded by a
WebRTC-capable torrent client.

Right now, we know of these WebRTC-capable torrent clients:

- **[KeplerJs Desktop][KeplerJs-desktop]** - Open source streaming torrent client. For Mac, Windows, and Linux.
- **[Vuze][vuze-support]** - Powerful, full-featured torrent client
- **[Playback][playback]** - Open source JavaScript video player **(super cool!)**
- **[`KeplerJs-hybrid`][KeplerJs-hybrid]** - Node.js package (command line and API)
- **[Instant.io][instant.io]** - Simple KeplerJs client in a website
- **[βTorrent][btorrent]** - Fully-featured browser KeplerJs client ([source code][btorrent-source])
- **[TorrentMedia][torrentmedia]** - Desktop KeplerJs client
- *More coming soon – [Send a PR][pr] to add your client to the list!*

### A bit more about `KeplerJs-hybrid`

In node.js, `KeplerJs-hybrid` can download torrents from WebRTC peers or TCP peers
(i.e. normal peers). You can use KeplerJs as a command line program, or
programmatically as a node.js package.

To install `KeplerJs-hybrid` run the following command in your terminal (add the
`-g` flag to install the command line program, omit it to install locally):

```
npm install KeplerJs-hybrid -g
```

Note: If you just need to use KeplerJs in the browser (where WebRTC is available
natively) then use [`KeplerJs`][KeplerJs] instead, which is faster to install
because it won't need to install a WebRTC implementation.

## Can KeplerJs clients on different websites connect to each other?

Yes! **KeplerJs works across the entire web.** KeplerJs clients running on one
...
websites (i.e. the KeplerJs script must be present on both sites).

## Who builds KeplerJs?

KeplerJs is built by [Feross Aboukhadijeh][feross] and hundreds of open source
contributors. The KeplerJs project is managed by
[KeplerJs, LLC][KeplerJs-io], as a non-profit project.
...
## What is KeplerJs, LLC?

"KeplerJs, LLC" is the legal entity that owns KeplerJs. KeplerJs is, and
always will be, **non-profit, open source, and free software**.

There are no plans to make a profit from KeplerJs.

## How is KeplerJs different from PeerCDN?
...
KeplerJs is an independent project started by [Feross Aboukhadijeh][feross] in
October 2013. Unlike PeerCDN, **KeplerJs is free software**, licensed under the
...
On a technical level, PeerCDN and KeplerJs were built with different goals in
...
KeplerJs, on the other hand, doesn't require clients to trust a centralized
server. Given a `.torrent` file or magnet link, the KeplerJs client downloads the
...
KeplerJs is an **OPEN Open Source Project**. Individuals who make significant and
...
IRC at `#KeplerJs` (freenode) and how you can get started.


[open-issues]: https://github.com/KeplerJs/KeplerJs/issues?state=open
[contributing]: https://github.com/KeplerJs/KeplerJs/blob/master/CONTRIBUTING.md

## Where can I learn more?

There are many talks online about KeplerJs. Here are a few:

### Intro to BitTorrent and KeplerJs (JSConf)
...
## KeplerJs supports sequential streaming. How does this affect the network?
...
KeplerJs supports streaming a torrent file "in order", which is useful for
...
## Why wasn't KeplerJs designed as an entirely-new, modern protocol?

BitTorrent is the most successful, most widely-deployed P2P protocol in existence.
It works really well. Our goal with KeplerJs was to bring BitTorrent to the web
in a way that interoperates with the existing torrent network.

Re-inventing the protocol would have made KeplerJs fundamentally incompatible
...
## Is it possible to do live streaming with KeplerJs?

KeplerJs cannot do live streaming out-of-the-box, however you can build a live
streaming solution on top of KeplerJs.
...
## Does KeplerJs leak your IP address when using a VPN? I heard that WebRTC leaks your IP address.
...
[KeplerJs Desktop][KeplerJs-desktop], [Vuze][vuze-support],
[KeplerJs-hybrid][KeplerJs-hybrid], [Playback][playback],
[instant.io][instant.io], or [βTorrent][btorrent].

In the browser, KeplerJs can only download torrents that are explicitly seeded to
...
To support video/audio streaming of arbitrary files, KeplerJs uses the
...
Open an issue on the KeplerJs [issue tracker][issues], or join us in
[Gitter][gitter] or on IRC at `#KeplerJs` (freenode).

[KeplerJs-io]: https://KeplerJs.io
[render-media]: https://github.com/feross/render-media/blob/master/index.js
[gitter]: https://gitter.im/KeplerJs/KeplerJs
[instant.io]: https://instant.io
[issues]: https://github.com/KeplerJs/KeplerJs/issues
[license]: https://github.com/KeplerJs/KeplerJs/blob/master/LICENSE
[peercdn]: http://www.peercdn.com/
[playback]: https://mafintosh.github.io/playback/
[pr]: https://github.com/KeplerJs/KeplerJs
[KeplerJs-hybrid]: https://npmjs.com/package/KeplerJs-hybrid
[KeplerJs]: https://npmjs.com/package/KeplerJs